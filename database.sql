...
create table `tb_dictionary` (
  ...
  `code` varchar(200) DEFAULT NULL COMMENT '内容',
  `description` varchar(250) DEFAULT NULL COMMENT '描述',
  PRIMARY KEY (`id`)
  ) ENGINE=InnoDB AUTO_INCREMENT=1 DEFAULT CHARSET=utf8 COMMENT='字典表';

insert into tb_dictionary (type, code, description) values ('default_register_role','role-f7943542d87a4f028f446b71d9ede25d','注册用户初始角色');
insert into tb_dictionary (type, code, description) values ('default_password','123456','用户默认密码');
